...
export default function App() {
  ...
  if(tela==="entrada") return (
    <div style={{...AppStyle,background:temaClaro?C.bg:"#040a04",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",padding:"56px 24px 110px",position:"relative",overflowY:"auto"}}>
