...
export default function App() {
        ...
        <div style={{padding:12}}>
          <div style={crd}>
            ...
            {ap.apontamentos.filter(r=>!r.cancelado).length>0&&(()=>{
              ...
              return (
                <div style={{display:"flex",gap:14,fontSize:11,color:C.txM,marginTop:6}}>
                  <span>Vel. méd.: <b style={{color:C.txD}}>{velM.toFixed(2)} km/h</b></span>
                  <span>Bicos méd.: <b style={{color:C.txD}}>{bicosM.toFixed(1)}</b></span>
                  <span>Vazão: <b style={{color:C.txD}}>{VAZAO_BICO_GLOBAL.toFixed(1)} L/min</b></span>
                </div>
              );
            })()}
  ...
  if(tela==="config") {
    const menuItens=[
      ...
      {id:"sobre",       label:"Sobre o sistema",        sub:"v8.0 · Banco · Repositório · Contexto"},
    ];
    return (
      <div style={AppStyle}>
